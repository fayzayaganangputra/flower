...
function setup() {
  canvas = createCanvas(windowWidth, windowHeight, WEBGL); // Gunakan ukuran jendela
  canvas.id('canvas');
...
function draw() {
  ...
  rotateY(-10);
  rotateX(-50);
  v = []; // Reset array v setiap frame untuk menghindari akumulasi data
...
function windowResized() {
  resizeCanvas(windowWidth, windowHeight); // Menyesuaikan ukuran kanvas saat ukuran jendela berubah
}
